...
----------
    ...
    n_estimators : int
        ...
        rounds.
    eval_set: Optional[float]
        Proportion of training data set aside for early stopping evaluation. 
        Additional parameter to standard model to avoid setting this in fit() method.
