...
def load_flchain(*, path="datasets/data/", return_X_y=True, as_frame=False):
    """add sklearn style documentation here
    """
...
def load_support(*, path="datasets/data/", return_X_y=True, as_frame=False):
    """add sklearn style documentation here
    """
    # TODO: preprocessing for orig data
...
def load_rgbsg(*, path="datasets/data/", return_X_y=True, as_frame=False):
    """add sklearn style documentation here
    """
    # TODO: preprocessing for orig data
